...
function normalizeHastElement(el, curBase, newBase) {
...
var ObsidianFlavoredMarkdown = /* @__PURE__ */ __name((userOpts) => {
  ...
  return {
    ...
    textTransform(_ctx, src) {
      ...
      if (opts.highlight) {
        src = src.toString();
        src = src.replaceAll(highlightRegex, (value, ...capture) => {
          const [inner] = capture;
...
function renderPage(slug2, componentData, components, pageResources2) {
      ...
      if (classNames.includes("transclude")) {
        ...
        if (blockRef?.startsWith("#^")) {
          ...
          if (blockNode) {
            ...
            node.children = [
              normalizeHastElement(blockNode, slug2, transcludeTarget),
              {
                type: "element",
                tagName: "a",
          ...
          node.children = [
            ...page.htmlAst.children.slice(startIdx, endIdx).map(
              (child) => normalizeHastElement(child, slug2, transcludeTarget)
            ),
            {
              type: "element",
              tagName: "a",
  ...
  const doc = /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { "data-slug": slug2, children: [
      /* @__PURE__ */ jsx4("div", { class: "marquee cloud", children: /* @__PURE__ */ jsx4("div", { class: "" }) }),
      /* @__PURE__ */ jsx4("div", { id: "quartz-root", class: "page", children: /* @__PURE__ */ jsxs(Body2, { ...componentData, children: [
        LeftComponent,
        /* @__PURE__ */ jsxs("div", { class: "center", children: [
          ...
          /* @__PURE__ */ jsx4("div", { class: "spacer" }),
          /* @__PURE__ */ jsx4("div", { class: "marquee content-footer", children: /* @__PURE__ */ jsx4("div", {}) })
        ] }),
        RightComponent
      ] }) })
    ] }),
...
function PageTitle({ fileData, cfg, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs9("h1", { class: `page-title ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsx16("div", { id: "page-title-icon" }),
    /* @__PURE__ */ jsx16("a", { id: "page-title-link", href: baseDir, children: /* @__PURE__ */ jsxs9("ruby", { id: "page-title-link-furi", children: [
      /* @__PURE__ */ jsx16("rt", { children: "Alex' Garden" }),
      title
    ] }) })
  ] });
}
...
function TableOfContents2({ fileData, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs10("div", { class: `toc ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsxs10("button", { type: "button", id: "toc", class: fileData.collapseToc ? "collapsed" : "", children: [
...
var Explorer_default = /* @__PURE__ */ __name((userOpts) => {
  ...
  function Explorer({ allFiles, displayClass, fileData }) {
    ...
    return /* @__PURE__ */ jsxs12("div", { class: `explorer ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsxs12(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsx21("div", { id: "explorer-content", children: /* @__PURE__ */ jsxs12("ul", { class: "overflow", id: "explorer-ul", children: [
...
var Graph_default = /* @__PURE__ */ __name((opts) => {
  function Graph({ displayClass }) {
    ...
    return /* @__PURE__ */ jsxs13("div", { class: `graph ${displayClass ?? ""}`, children: [
...
function Backlinks({ fileData, allFiles, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs14("div", { class: `backlinks ${displayClass ?? ""}`, children: [
...
var Search_default = /* @__PURE__ */ __name(() => {
  function Search({ displayClass }) {
    return /* @__PURE__ */ jsxs15("div", { class: `search ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsxs15("div", { id: "search-icon", children: [
      ...
      /* @__PURE__ */ jsx25("div", { id: "search-container", children: /* @__PURE__ */ jsxs15("div", { id: "search-space", children: [
        /* @__PURE__ */ jsx25(
          "input",
          {
            autocomplete: "off",
...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  function Footer({ displayClass }) {
    ...
    return /* @__PURE__ */ jsx26("footer", { class: `${displayClass ?? ""}`, children: /* @__PURE__ */ jsx26("hr", {}) });
  }
...
var AliasRedirects = /* @__PURE__ */ __name(() => ({
  ...
  async emit({ argv }, content, _resources, emit) {
    ...
    for (const [_tree, file] of content) {
      ...
      aliases = aliases.filter((alias) => typeof alias === "string" && alias.length > 0);
    ...
    theme: {
      ...
      colors: {
        lightMode: {
          ...
          dark: "#2b2b2b",
          secondary: "#808c27",
          // changed to a green shade
          tertiary: "#6a7326",
          // changed to a lighter green
          highlight: "rgba(118, 185, 71, 0.10)"
          // less intense green-tinted highlight
        },
        darkMode: {
          light: "#161618",
          lightgray: "#393639",
          ...
          // changed to a green shade
          tertiary: "#76b947",
          // consistent with light mode tertiary
          highlight: "rgba(118, 185, 71, 0.15)"
          // green-tinted highlight
        }
      }
    }
  },
